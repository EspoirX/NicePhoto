...
class CircleImageView : ImageView {
    ...
    constructor(context: Context, attrs: AttributeSet) : super(context, attrs, 0) {
        val a = context.obtainStyledAttributes(attrs, R.styleable.RefreshCircleImageView, 0, 0)

        mBorderWidth = a.getDimensionPixelSize(R.styleable.RefreshCircleImageView_border_width, DEFAULT_BORDER_WIDTH)
        mBorderColor = a.getColor(R.styleable.RefreshCircleImageView_border_color2, DEFAULT_BORDER_COLOR)
    ...
    constructor(context: Context, attrs: AttributeSet, defStyle: Int) : super(context, attrs, defStyle) {
        val a = context.obtainStyledAttributes(attrs, R.styleable.RefreshCircleImageView, defStyle, 0)
